...
window.onload = function () {
  var faculties = document.querySelectorAll('.faculty');
  ...
  var _loop = function _loop(i) {
    faculties[i].addEventListener('click', function () {
      hideColleges();
  ...
  function hideColleges() {
    for (var _i = 0; _i < colleges.length; _i++) {
      faculties[_i].classList.remove('slanted-div-active');

      colleges[_i].style.display = 'none';
    }
  }
};
